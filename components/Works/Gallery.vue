<template>
  <section>
    <section id="1st-gallery" class="gallery4 mbr-gallery cid-sLlrDxCZpU">
      <div class="container">
        <div class="mbr-section-head">
          <h3 class="mbr-section-title mbr-fonts-style align-center m-0 display-1">
            <strong>View our websites built</strong>
          </h3>
          <h4 class="mbr-section-subtitle mbr-fonts-style align-center mb-0 mt-2 display-5">
            and view them live with their URLs ...
          </h4>
        </div>
        ...
        <div id="sLlDvFKULd-modal" class="modal mbr-slider" tabindex="-1" role="dialog" aria-hidden="true">
              ...
              <div class="modal-body">
                <div id="lb-sLlDvFKULd" class="carousel slide carousel-fade" data-ride="carousel" data-interval="5000">
                  ...
                  <ol class="carousel-indicators">
                    <li data-slide-to="0" class="active" data-target="#lb-sLlDvFKULd" />
                    <li data-slide-to="1" data-target="#lb-sLlDvFKULd" />
                    <li data-slide-to="2" data-target="#lb-sLlDvFKULd" />
                    <li data-slide-to="3" data-target="#lb-sLlDvFKULd" />
                  </ol>
                  <a role="button" href="" class="close" data-dismiss="modal" aria-label="Close" />
                  <a class="carousel-control-prev carousel-control" role="button" data-slide="prev" href="#lb-sLlDvFKULd">
                    <span class="mobi-mbri mobi-mbri-arrow-prev" aria-hidden="true" />
                    <span class="sr-only">Previous</span>
                  </a>
                  <a class="carousel-control-next carousel-control" role="button" data-slide="next" href="#lb-sLlDvFKULd">
                    <span class="mobi-mbri mobi-mbri-arrow-next" aria-hidden="true" />
    ...
    <section id="2nd-gallery" class="gallery4 mbr-gallery cid-sLluVYn5Li">
      <div class="container">
        <div class="mbr-section-head">
          <h3 class="mbr-section-title mbr-fonts-style align-center m-0 display-1">
            <strong>View our hand built hardware</strong>
          </h3>
          <h4 class="mbr-section-subtitle mbr-fonts-style align-center mb-0 mt-2 display-5">
            and get exclusive preview of non-released hardware devices and gadgets ...
          </h4>
        </div>
        <div class="row mbr-gallery mt-4">
          <div class="col-12 col-md-6 col-lg-6 item gallery-image">
        ...
        <div id="sLlDvJTbFA-modal" class="modal mbr-slider" tabindex="-1" role="dialog" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-body">
                <div id="lb-sLlDvJTbFA" class="carousel slide carousel-fade" data-ride="carousel" data-interval="5000">
                  ...
                  <ol class="carousel-indicators">
                    <li data-slide-to="0" class="active" data-target="#lb-sLlDvJTbFA" />
                    <li data-slide-to="1" data-target="#lb-sLlDvJTbFA" /><li data-slide-to="2" data-target="#lb-sLlDvJTbFA" /><li data-slide-to="3" data-target="#lb-sLlDvJTbFA" />
                  </ol>
                  <a role="button" href="" class="close" data-dismiss="modal" aria-label="Close" />
                  <a class="carousel-control-prev carousel-control" role="button" data-slide="prev" href="#lb-sLlDvJTbFA">
                    <span class="mobi-mbri mobi-mbri-arrow-prev" aria-hidden="true" />
                    <span class="sr-only">Previous</span>
                  </a>
                  <a class="carousel-control-next carousel-control" role="button" data-slide="next" href="#lb-sLlDvJTbFA">
                    <span class="mobi-mbri mobi-mbri-arrow-next" aria-hidden="true" />
                    <span class="sr-only">Next</span>
                  </a>
                </div>
