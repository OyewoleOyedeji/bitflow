<template>
  <main>
    ...
    <!-- This is the local `PageTransition` component -->
    <PageTransition />

    <!-- This is the local `OurTeam` component-->
    <OurTeam />

    <!-- This is the local `OurClients` component -->
    <OurClients />

    <!-- This is the local `ContactForm` component -->
    <ContactForm />
